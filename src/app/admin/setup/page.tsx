      ...
      <div className="w-full max-w-2xl rounded-2xl border border-neutral-200 bg-white p-8 shadow-sm">
        ...
        <div className="space-y-6">
          <div className="rounded-lg border border-neutral-200 bg-neutral-50 p-6">
            <h2 className="mb-4 font-serif text-lg text-neutral-900">
              設定手順
            </h2>
...
NEXT_PUBLIC_SUPABASE_ANON_KEY=your-anon-key`}
              ...
              <li>
                Supabaseプロジェクトの設定から、Project URLとAnon public
                keyを取得
              </li>
              <li>開発サーバーを再起動</li>
            </ol>
          ...
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-6">
            <h3 className="mb-2 font-serif text-base text-blue-900">
              詳細な手順
            </h3>
            <p className="text-sm text-blue-800">
              詳細なセットアップ手順は{" "}
              <code className="rounded bg-blue-200 px-1.5 py-0.5 text-xs">
