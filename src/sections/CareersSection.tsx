...
export function CareersSection({ positions }: CareersSectionProps) {
  ...
  return (
    ...
    >
      <div className="grid w-full max-w-5xl grid-rows-[auto_1fr] px-4 pb-8 pt-24 sm:px-6 sm:pb-12 sm:pt-28 md:px-8 md:pb-16 md:pt-32 lg:px-10 lg:pb-20 lg:pt-36 xl:pb-28 xl:pt-40 2xl:pb-32 2xl:pt-44">
