...
export function ContactSection() {
  return (
    ...
    >
      ...
      <div className="relative z-10 flex w-full flex-1 justify-center px-4 pb-16 pt-16 sm:px-6 sm:pb-20 sm:pt-20 md:px-8 md:pb-20 md:pt-24 lg:px-10 lg:pb-16 lg:pt-24 xl:pb-16 xl:pt-24 2xl:pb-16 2xl:pt-24">
        <div className="grid w-full max-w-5xl flex-1 grid-rows-[auto_1fr] gap-6 text-left sm:gap-8 md:gap-10">
