  ...
  return (
    <div className="fixed inset-0 z-140 animate-in fade-in duration-300">
      <div
        ...
        aria-hidden="true"
      />
      <div className="relative mx-auto flex h-full max-w-xl flex-col items-center justify-center px-4 py-10 text-white animate-in zoom-in-95 duration-300">
        <div className="relative w-full overflow-hidden rounded-[2rem] border border-white/10 bg-[#111]/90 px-6 py-8 shadow-[0_0_80px_rgba(0,0,0,0.5)] backdrop-blur-xl sm:px-10 sm:py-10">
          <div
